...
<% 
	...
	String useridChk2 = (String)session.getAttribute("userid");
	System.out.println("바로 주문페이지 아이디 : " + useridChk2);
%>
<%
    ...
    <div class="div_k2">
        ...
        <div class="div_cart_2_1">
            <table class="table_cart_2_1">
                ...
                <tr>
	                ...
	                <tr>
	                    <td>
	                        <img src="images/<%=p_thumbnail %>" alt="grrrr" style="width:220px; height:202px">
	                    </td>
	                    <td><%=p_name %>(<%=o_option %>)</td>
	                    <td><%=c_quantity %>개</td>
	                    <td><%=p_price %>원</td>
	                    <td><%=c_reserve %>원</td>
	                </tr>
        ...
        <div class="div_cart_2_6">
            <table class="table_cart_2_6">
                ...
                <tr>
                    <th>최종 결제금액</th>
                    <td><%=p_price %>원 (적립예정: <%=c_reserve %>원)<br>
